...
var ToDoList = function (_React$Component2) {
  ...
  _createClass(ToDoList, [{
    ...
    value: function fetchTasks() {
      ...
      fetch("https://altcademy-to-do-list-api.herokuapp.com/tasks?api_key=489").then(checkStatus).then(json).then(function (response) {
    ...
    value: function handleSubmit(event) {
      ...
      fetch("https://altcademy-to-do-list-api.herokuapp.com/tasks?api_key=489", {
        method: "POST",
        mode: "cors",
    ...
    value: function deleteTask(id) {
      ...
      fetch("https://altcademy-to-do-list-api.herokuapp.com/tasks/" + id + "?api_key=489", {
        method: "DELETE",
        mode: "cors"
      }).then(checkStatus).then(json).then(function (data) {
        _this5.fetchTasks();
    ...
    value: function toggleComplete(id, completed) {
      ...
      fetch("https://altcademy-to-do-list-api.herokuapp.com/tasks/" + id + "/mark_" + newState + "?api_key=489", {
        method: "PUT",
        mode: "cors"
      }).then(checkStatus).then(json).then(function (data) {
        _this6.fetchTasks();
